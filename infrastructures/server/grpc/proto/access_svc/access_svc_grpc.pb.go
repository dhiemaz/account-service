...
const (
	AccessService_SearchAccessData_FullMethodName = "/access_svc.AccessService/SearchAccessData"
)
...
func _AccessService_SearchAccessData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(AccessServiceServer).SearchAccessData(ctx, in)
	}
...
var AccessService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "access_svc.AccessService",
	HandlerType: (*AccessServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SearchAccessData",
			Handler:    _AccessService_SearchAccessData_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "access_svc.proto",
}
